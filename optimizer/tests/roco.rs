...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/roco_llama_cost6_kern2.json",
        6,
        2,
    ) {
    ...
    let file =
        File::create("/home/jhpark676/Project/trinity/expressions/roco_llama_cost6_kern2.txt")
...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/roco_falcon_cost6_kern2.json",
        6,
        2,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file =
        File::create("/home/jhpark676/Project/trinity/expressions/roco_falcon_cost6_kern2.txt")
            .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "./expressions/semi/roco_split_part2_cost3_kern1.json",
        3,
        1,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file = File::create("./expressions/roco_split_part2_cost3_kern1.txt")
        .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/roco_rocoonly_cost6_kern1.json",
        6,
        1,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file =
        File::create("/home/jhpark676/Project/trinity/expressions/roco_rocoonly_cost6_kern1.txt")
            .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
