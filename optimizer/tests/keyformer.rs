...
(seq
    ...
    let semi_path = expr_path.join("semi/keyformer_llama_cost6_kern1.json");
    let output_path = expr_path.join("keyformer_llama_cost6_kern1.txt");
...
(seq
    ...
    let expr_path = get_expressions_path();
    let semi_path = expr_path.join("semi/keyformer_falcon_cost6_kern1.json");
    let output_path = expr_path.join("keyformer_falcon_cost6_kern1.txt");
