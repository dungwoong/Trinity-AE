...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/keyformer_llama_cost6_kern2.json",
        6,
        2,
    ) {
    ...
    let file =
        File::create("/home/jhpark676/Project/trinity/expressions/keyformer_llama_cost6_kern2.txt")
...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/keyformer_falcon_cost6_kern2.json",
        6,
        2,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file = File::create(
        "/home/jhpark676/Project/trinity/expressions/keyformer_falcon_cost6_kern2.txt",
    )
    .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
