...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/prenorm_llama_cost6_kern1.json",
        6,
        1,
    ) {
    ...
    let file =
        File::create("/home/jhpark676/Project/trinity/expressions/prenorm_llama_cost6_kern1.txt")
...
(seq
    ...
    let (expressions, tile_sets) = match list_expressions_from_semi_with_cost(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/prenorm_falcon_cost6_kern2.json",
        usize::MAX,
    ) {
        Ok((expressions, tile_sets)) => {
            println!("Loaded {} final expressions", expressions.len());
    ...
    let file = File::create(
        "/home/jhpark676/Project/trinity/expressions/prenorm_falcon_cost6_kern2_wo_postprocess.txt",
    )
    .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "./expressions/semi/prenorm_split_part1_cost6_kern1.json",
        6,
        1,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file = File::create("./expressions/prenorm_split_part1_cost6_kern1.txt")
        .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/prenorm_attnonly_cost6_kern1.json",
        6,
        1,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file = File::create(
        "/home/jhpark676/Project/trinity/expressions/prenorm_attnonly_cost6_kern1.txt",
    )
    .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
...
(seq
    ...
    let mut runner = run_until_saturated(expr, rules(), 5);
    save_egraph(
        &runner,
        "/home/jhpark676/Project/trinity/prenorm_prenormonly_egraph.dot",
    );
    return;

    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/prenorm_prenormonly_cost6_kern2.json",
        6,
        2,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file = File::create(
        "/home/jhpark676/Project/trinity/expressions/prenorm_prenormonly_cost6_kern2.txt",
    )
    .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
