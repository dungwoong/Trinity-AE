...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/vanilla_llama_cost6_kern2.json",
        6,
        2,
    ) {
    ...
    let file =
        File::create("/home/jhpark676/Project/trinity/expressions/vanilla_llama_cost6_kern2.txt")
...
(seq
    ...
    let (expressions, tile_sets) = match list_expressions_from_semi_with_cost(
        &runner,
        "/home/jhpark676/Project/trinity/expressions/semi/vanilla_falcon_cost6_kern2.json",
        usize::MAX,
    ) {
        Ok((expressions, tile_sets)) => {
            println!("Loaded {} final expressions", expressions.len());
    ...
    let file = File::create(
        "/home/jhpark676/Project/trinity/expressions/vanilla_falcon_cost6_kern2_wo_postprocess.txt",
    )
    .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "./expressions/semi/vanilla_split_part1_cost6_kern1.json",
        6,
        1,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file = File::create("./expressions/vanilla_split_part1_cost6_kern1.txt")
        .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
...
(seq
    ...
    match list_expressions_with_target_cost_v3_part1(
        &runner,
        "./expressions/semi/vanilla_split_part2_cost6_kern1.json",
        6,
        1,
    ) {
        Ok(count) => println!("Saved {} expressions", count),
    ...
    let file = File::create("./expressions/vanilla_split_part2_cost6_kern1.txt")
        .expect("Failed to create file");
    let mut writer = BufWriter::new(file);
